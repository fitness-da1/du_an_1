...
<head>
    ...
    <title>Heroism Gym Theme - Gallery 2 Page</title>
...
<body>
    ...
    <section class="our-gallery-area gallery-2-area">
        <div class="container">
            ...
            <div class="row shuffle-wrapper">
                <div class="col-lg-4 col-6 mb-30 shuffle-item wow fadeIn"
                    ...
                    <div class="position-relative hover-wrapper">
                        <img src="assets/img/gallery-img/gallery-2/1.jpg" alt="portfolio-image"
                ...
                <div class="col-lg-4 col-6 mb-30 shuffle-item wow fadeIn" data-groups="[&quot;gym&quot;]"
                    ...
                    <div class="position-relative hover-wrapper">
                        <img src="assets/img/gallery-img/gallery-2/2.jpg" alt="portfolio-image"
                            class="img-fluid w-100 d-block">
                        <div class="hover-overlay">
                            <div class="hover-content">
                                <a class="btn btn-sm venobox" data-gall="myGallery"
                ...
                <div class="col-lg-4 col-6 mb-30 shuffle-item wow fadeIn" data-groups="[&quot;running&quot;]"
                    data-wow-duration="0.5s" data-wow-delay=".25s">
                    <div class="position-relative hover-wrapper">
                        <img src="assets/img/gallery-img/gallery-2/3.jpg" alt="portfolio-image"
                            class="img-fluid w-100 d-block">
                        <div class="hover-overlay">
                            <div class="hover-content">
                                <a class="btn btn-sm venobox" data-gall="myGallery"
                ...
                <div class="col-lg-4 col-6 mb-30 shuffle-item wow fadeIn"
                    ...
                    <div class="position-relative hover-wrapper">
                        <img src="assets/img/gallery-img/gallery-2/4.jpg" alt="portfolio-image"
                            class="img-fluid w-100 d-block">
                        <div class="hover-overlay">
                            <div class="hover-content">
                                <a class="btn btn-sm venobox" data-gall="myGallery"
                ...
                <div class="col-lg-4 col-6 mb-30 shuffle-item wow fadeIn" data-groups="[&quot;fitness&quot;]"
                    data-wow-duration="0.5s" data-wow-delay=".25s">
                    <div class="position-relative hover-wrapper">
                        <img src="assets/img/gallery-img/gallery-2/5.jpg" alt="portfolio-image"
                            class="img-fluid w-100 d-block">
                        <div class="hover-overlay">
                            <div class="hover-content">
                                <a class="btn btn-sm venobox" data-gall="myGallery"
                ...
                <div class="col-lg-4 col-6 mb-30 shuffle-item wow fadeIn" data-groups="[&quot;strength&quot;]"
                    data-wow-duration="0.5s" data-wow-delay=".25s">
                    <div class="position-relative hover-wrapper">
                        <img src="assets/img/gallery-img/gallery-2/6.jpg" alt="portfolio-image"
                            class="img-fluid w-100 d-block">
                        <div class="hover-overlay">
                            <div class="hover-content">
                                <a class="btn btn-sm venobox" data-gall="myGallery"
                ...
                <div class="col-lg-4 col-6 mb-30 shuffle-item wow fadeIn" data-groups="[&quot;strength&quot;]"
                    data-wow-duration="0.5s" data-wow-delay=".25s">
                    <div class="position-relative hover-wrapper">
                        <img src="assets/img/gallery-img/gallery-2/7.jpg" alt="portfolio-image"
                            class="img-fluid w-100 d-block">
                        <div class="hover-overlay">
                            <div class="hover-content">
                                <a class="btn btn-sm venobox" data-gall="myGallery"
                ...
                <div class="col-lg-4 col-6 mb-30 shuffle-item wow fadeIn"
                    ...
                    data-wow-delay=".25s">
                    <div class="position-relative hover-wrapper">
                        <img src="assets/img/gallery-img/gallery-2/8.jpg" alt="portfolio-image"
                            class="img-fluid w-100 d-block">
                        <div class="hover-overlay">
                            <div class="hover-content">
                                <a class="btn btn-sm venobox" data-gall="myGallery"
                ...
                <div class="col-lg-4 col-6 mb-30 shuffle-item wow fadeIn"
                    ...
                    data-wow-delay=".25s">
                    <div class="position-relative hover-wrapper">
                        <img src="assets/img/gallery-img/gallery-2/9.jpg" alt="portfolio-image"
                            class="img-fluid w-100 d-block">
                        <div class="hover-overlay">
                            <div class="hover-content">
                                <a class="btn btn-sm venobox" data-gall="myGallery"
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="footer-bottom-part">
                            <div class="copyright"><a href="https://anditthemes.com/">webguru071</a> &copy; 2019. All
                                Rights Reserved</div>
