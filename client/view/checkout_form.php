...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">Form Pay</h4>
            ...
            <form id="example-form" action="#" class="m-t-40">
                <div>
                    ...
                    <section>
                        ...
                        <input id="phone" name="phone" type="text" maxlength="10" class="required form-control">
...
<!-- this page js -->
<script src="view/assets/libs/jquery-steps/build/jquery.steps.min.js"></script>
<script src="view/assets/libs/jquery-validation/dist/jquery.validate.min.js"></script>
<script>
