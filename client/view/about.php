<?php include_once './layout/header.php'?>
    ...
    <!-- About Us Area Start -->
    <section class="about-us-area about-page-about-section">
        <div class="container">
            <!-- Row Start-->
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-6 text-left">
                    <div class="about-content-wrap">
                        ...
                        <h3 class="section-subheading">Aliquam erat volutpat. Curabitur tempor nibh quis arcu convallis,
                            sed viverra quam sollicitudin. Proin sed augue sed neque ultricies </h3>
                        <h3 class="section-subheading">Integer iaculis nec ipsum nec imperdiet. Duis posuere, quam id
                            porttitor accumsan, lacus lorem efficitur enim, ac fermentum felis leo vel urna. Nulla
                            facilisi. Etiam vestibulum convallis laoreet. Praesent fermentum vulputate sapien quis
                            rutrum. </h3>

                        <!-- About Expertise Wrap Start-->
                        <div class="about-expertise-wrap">

                            <div class="panel-group" id="accordion6" role="tablist" aria-multiselectable="true">

                                <!-- Single About Expertise Start-->
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingOne6">
                                        <h4 class="panel-title">
                                            <a class="font-17" role="button" data-toggle="collapse"
                                                data-parent="#accordion6" href="#collapseOne6" aria-expanded="true"
                                                aria-controls="collapseOne6">
                                                Low Prices
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="collapseOne6" class="panel-collapse collapse show" role="tabpanel"
                                    ...
                                    <div class="panel-heading" role="tab" id="headingTwo6">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse"
                                                data-parent="#accordion6" href="#collapseTwo6" aria-expanded="false"
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="headingThree6">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse"
                                                data-parent="#accordion6" href="#collapseThree6" aria-expanded="false"
    ...
    <section class="call-to-action-area only-for-about-page">

        <!-- We Are Ready To Area-->
        <div class="we-are-ready position-relative">
            <div class="section-overlay">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="we-are-ready-content">
        ...
        <div class="membership-offer-area d-flex">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="membership-offer-content">
                            <div class="membership-offer-left">
