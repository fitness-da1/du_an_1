<?php include_once 'view/layout/header.php' ?>
            ...
            <div class="container">
                <div class="header-caption text-left">
                    <h1 class="header-caption-heading text-capitalize wow fadeInUp" data-wow-duration="1.2s"
                        data-wow-delay=".5s">Our Categories</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".5s">
                            ...
                            <li class="breadcrumb-item active text-capitalize" aria-current="page">Our categories</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="our-classes classes-page-class-section position-relative">
        <div class="container">
            <div class="row">
                <div class="all-classes-slider owl-carousel">
                    ...
                    <?php foreach ($categorie as $ca): ?>
                        <div class="item">
                            <div class="single-class-box">
                                <div class="class-img">
                                    <img src="view/assets/img/our-classes-img/1.jpg" alt="class img">

                                </div>
                                <div class="single-class-content">
                                    <!--                                <a href="classes.html">-->
                                    <h4 class="text-uppercase"><?= $ca->categories_name ?></h4>
                                    <!--                                </a>-->
                                    <p class="label_title"><?= $ca->categories_meaningful ?>
                                    </p>
                                    <a href="?ctr=detail_categorie&id=<?= $ca->id?>" class="btn round-button">- Learn More</a>
                                </div>
                    ...
                    <!--                        <div class="single-class-box">-->
                    <!--                            <div class="class-img">-->
                    <!--                                <img src="view/assets/img/our-classes-img/2.jpg" alt="class img">-->
                    ...
                    <!--                                    nunc maximus. </p>-->
                    <!--                                <a href="?ctr=detail_categorie" class="btn round-button">- Learn More</a>-->
                    <!--                            </div>-->
                    <!---->
                    <!--                        </div>-->
                    <!--                    </div>-->
                    ...
                    <!--                        <div class="single-class-box">-->
                    <!--                            <div class="class-img">-->
                    <!--                                <img src="view/assets/img/our-classes-img/3.jpg" alt="class img">-->
                    <!--                                <p class="class-fees"><span>100$</span></p>-->
                    <!--                            </div>-->
                    <!--                            <div class="single-class-content">-->
                    <!--                                <a href="classes.html">-->
